...
static size_t do_io(int fd,OriginFun fun,const char* hook_fun_name,
...
ssize_t readv(int fd,const struct iovec* iov,size_t count)
{
    return do_io(fd,readv_f,"readv", sylar::IOManager::READ, SO_RCVTIMEO, iov,count);
}
